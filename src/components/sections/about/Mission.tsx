	...
	return (
		<section className="mt-15 xl:mt-30">
			<div className="custom-container">
				<h3 className="mx-auto font-semibold sm:text-lg mb-3.5 md:mb-7.5 bg-secondary-100 w-fit rounded-[30px] px-7.25 py-[5.5px] lg:text-2xl">
					Vision & Mission
				</h3>

				<p className="p2 mt-3.5 text-center max-w-2xl mx-auto">
				...
				<div className="mt-7.5 lg:mt-15 flex flex-col gap-7.5 lg:flex-row lg:gap-15">
					<div className="flex flex-col items-center gap-7.5 flex-1 lg:gap-15 lg:items-start">
						<div>
					...
					<div className="flex-1">
						<h4 className="text-xl text-center md:text-2xl font-bold lg:text-[32px]">
							Our Values
						</h4>
						<ul className="mt-7.5 space-y-7.5 lg:space-y-15">
							{values.map((v, i) => (
